...
import { ChevronDownIcon } from '@heroicons/react/20/solid'
  ...
  //   { name: 'Manajemen Proyek', href: '/manajemen-projek', current: false },
  //   { name: 'Manajemen User', href: '/manajemen-user', current: false },
  //   { name: 'Proyek', href: '/projek', current: false },
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img
                  className="h-8 w-8"
                  src="https://images.glints.com/unsafe/glints-dashboard.s3.amazonaws.com/company-logo/69d10eaa19dffcd1db7b51c2c6d8c039.png"
                  alt="Your Company"
                />
              </div>
