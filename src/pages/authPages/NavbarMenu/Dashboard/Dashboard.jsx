            ...
            <div className="mx-auto">
                <div className="bg-gradient-to-r from-indigo-950 to-indigo-500 bg-gray-800 p-8 md:p-12 mb-8">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                      ...
                      <p className="text-lg font-normal text-gray-300 mb-6">Semoga kegiatan bekerjamu berjalan menyenangkan.</p>
                  ...
                  {/* Section 1 */}
                    ...
                    <div className="bg-white border border-gray-200 lg:rounded-lg p-6 md:px-6 md:py-6 lg:shadow-xl">
                      <div className="inline-flex">
                        ...
                        <div className="text-xl font-medium ml-2 text-gray-700">Aktivitas Pekerjaan</div>
                      </div>
                          ...
                          <div className="grid md:grid-cols-2 gap-4">
                              <a href="/projek" className="hover:border hover:border-slate-400 hover:rounded-md">
                                  <div className="bg-gray-50 border border-gray-200  rounded-lg p-2 md:p-4">
                                      ...
                                      <p className="font-extrabold text-md text-gray-600 ml-2  -mt-2">Cari Proyek</p>
                                  </div>
                              </a>
                              <a href="/personal" className="hover:border hover:border-slate-400 hover:rounded-md">
                                  <div className="bg-gray-50 border border-gray-200  rounded-lg p-2 md:p-4">
                                      ...
                                      <p className="font-extrabold text-md text-gray-600 ml-2  -mt-2">Proyek</p>
                                  </div>
                              </a>
                              </div>
                      </section>
                    ...
                    <div className="bg-white border border-gray-200 lg:rounded-lg p-6 md:px-6 md:py-6 lg:shadow-xl">
                          <div className="inline-flex">
                            ...
                            <div className="text-xl font-medium ml-2 text-gray-700">Proyek Ku</div>
                          </div>
