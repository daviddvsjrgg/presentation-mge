...
const AddManajemenProjek = () => {
    ...
    if (namaProjek === '' || label === '' || setPenggunaValidation === '' ) {
      ...
      try {
        ...
        if (querySnapshot.size === 0) {
              ...
              setErrorMessageNamaProjek("Nama proyek sudah ada & label sama")
            }
      } catch (error) {
        console.log(error);
      }
  ...
  const namaProjekValidation = () => {
    if (namaProjek === '') {
      window.scrollTo({ top: 0, left: 0, behavior: 'smooth' });
      setErrorMessageNamaProjek("Nama proyek tidak boleh kosong")
    }
  }
     ...
     <div className="min-h-full">
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            Data kamu berhasil tersimpan, data akan muncul di halaman "Proyek" dengan Gambar, Proyek, dan Penanggung Jawab atas Matkul tersebut.
                          </p>
                        </div>
                      </div>
                    </div>
      ...
      <header className="bg-white drop-shadow-md">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Tambah Proyek</h1>
        </div>
      </header>
      {/* Start - Content */}
      <main>
        ...
        { success && (
          <div id="alert-3" className="animate-bounce flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-200 " role="alert">
            ...
            <div className="space-y-12">
                ...
                <h2 className="text-base font-semibold leading-7 text-gray-900">Profil Proyek</h2>
                <p className="mt-1 text-sm leading-6 text-gray-600">
                    Masukkan informasi Proyek kamu, pada form dibawah.
                </p>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2 sm:max-w-md">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <p className="mt-3 text-sm leading-6 text-gray-600">Tulis deskripsi Proyek yang akan dibuat.</p>
                    </div>
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <Combobox  defaultValue={selected} onChange={setSelected}>
                  <div className="relative mt-2">
                    ...
                    <p className="mt-3 text-sm leading-6 text-gray-600 pl-1">Pilih penanggung jawab dari users untuk mengatur Proyek.</p>
                  </div>
                </Combobox>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="mt-3 pl-1 text-sm leading-6 text-gray-600">Label akan menjadi tagline Proyek.</p>
                  </div>
                </div>
              </div>
