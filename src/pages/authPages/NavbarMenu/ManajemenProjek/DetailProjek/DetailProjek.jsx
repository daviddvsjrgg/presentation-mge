                        ...
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-2">
                                <p className="text-sm text-gray-500">
                                 Apakah kamu yakin menghapus akun di Proyek ini? Proses ini tidak bisa dibatalkan.
                                </p>
                            </div>
                            </div>
                        </div>
        ...
        {/* End Modal */}
            <header className="bg-white drop-shadow-md">
                <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900">Detail Proyek</h1>
                </div>
            </header>
                ...
                <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                    {projectData ? (
                        ...
                        <div className="px-4 sm:px-0">
                            <h3 className="text-base font-semibold leading-7 text-gray-900 mt-4">Detail Proyek</h3>
                            <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">Informasi Proyek berisi gambar, pengguna terkait, dan detail lainnya.</p>
                        </div>
                        <div className="mt-6 border-t border-gray-100">
                            ...
                            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                <dt className="text-sm font-medium leading-6 text-gray-900">Proyek</dt>
                            ...
                            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                <dt className="text-sm font-medium leading-6 text-gray-900">Tentang Proyek</dt>
                    ...
                    :
                        <div className="px-4 sm:px-0">
                            <h3 className="text-base font-semibold leading-7 text-gray-900">Detail Proyek</h3>
