    ...
    <div className="min-h-full">
      ...
      <header className="bg-white drop-shadow-md">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Manajemen Proyek</h1>
        </div>
      </header>
                ...
                <div className="order-last">
                    <a href="/manajemen-projek/projek-baru" className=" hover:text-white group block max-w-sm rounded-lg p-2.5 bg-gray-50 ring-1 ring-slate-900/5 shadow-sm space-y-3 hover:bg-indigo-500 hover:ring-indigo-300">
                      <div className="flex items-center space-x-3">
                        ...
                        <h3 className="text-slate-900 text-sm font-semibold group-hover:text-white">Proyek Baru</h3>
                      </div>
                    </a>
                </div>
                <div>       
                    ...
                    <tbody>
                      <tr className="animate-pulse">
                        <td className="px-2 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="ml-5">
                              <div className="text-sm font-medium text-gray-900">Belum ada proyek
                              </div>
                            </div>
                          </div>
                        </td>
