        ...
        <div className="mx-auto max-w-7xl">
            ...
            <>
                <div className="inline-flex bg-gray-200 w-full rounded-t-md py-2">
                    ...
                    <div className="text-md md:text-xl font-medium ml-2 text-gray-700">PIC Proyek</div>
                </div>
            ...
            <div className="inline-flex bg-gray-200 w-full rounded-t-md py-2">
                ...
                <div className="text-md md:text-xl font-medium ml-2 text-gray-700">Proyek</div>
            </div>
