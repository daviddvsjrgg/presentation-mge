                        ...
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-2">
                                <p className="text-sm text-gray-500">
                                 Apakah kamu yakin menghapus berita di Proyek ini? Proses ini tidak bisa dibatalkan.
                                </p>
                            </div>
                            </div>
                        </div>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-md bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    {projectData.labelProject.split(" ")[0] === "Bangkit" ? "Buat Berita Bangkit" : projectData.labelProject === "MGE" ? "Buat Berita" : "Buat Berita"}
                  </Dialog.Title>
              ...
              >
                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-md bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    ...
                    className="text-lg font-medium leading-6 text-gray-900"
                  >
                    {projectData.labelProject.split(" ")[0] === `Bangkit` ? "Buat Deadline Bangkit" : projectData.labelProject === "MGE" ? "Buat Deadline Pekerjaan" : `Buat Deadline Proyek - ${projectData.nameProject} ${projectData.nameProject.includes("-") ? '' : `(${projectData.labelProject})`}`}
                  </Dialog.Title>
                  <div className="divider"></div> 
                  <div className="-mt-3">
                     <div className="sm:col-span-3">
                ...
                >
                    ...
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        ...
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            ...
                            <div className="mt-2">
                            <p className="text-sm text-gray-500">
                                Informasi Proyek berhasil tersimpan, kembali dalam {count} detik
                            </p>
                            </div>
                        </div>
                        </div>
            ...
            {fetchedUsers ? (
                ...
                <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                    <div className="flex w-0 flex-1 items-center">
                        ...
                        <span className="truncate font-medium animate-pulse">Loading Daftar Pekerjaan</span>
    ...
    {projectData ? (
            ...
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <div className="lg:flex lg:justify-between">
                    ...
                    <ul className='text-gray-600'>
                        ...
                        {projectData.labelProject.split(" ")[0] === "Bangkit" ? "Proyek" : projectData.labelProject === "MGE" ? "Proyek" : "Proyek"}
                        </Link>
                        </li> 
                        <li>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                        ...
                        <div className="card rounded-none w-auto border-2 border-gray-200">
                            ...
                            <div className="card rounded-md w-auto bg-base-100 shadow-xl">
                                ...
                                <div className="card-body">
                                    ...
                                    {projectData.labelProject.split(" ")[0] === "Bangkit" ? "Berita Bangkit" : projectData.labelProject === "MGE" ? "Berita" : "Berita"}
                                    </h2>
                                    <div className='-mt-12'></div>
                                    <div className='divider'></div>
                                ...
                                <li>
                                    ...
                                    {projectData.labelProject.split(" ")[0] === "Bangkit" ? "Deadline Bangkit" : projectData.labelProject === "MGE" ? "Deadline Tugas/Pekerjaan" : "Deadline Tugas/Pekerjaan"}
                                    </summary>
                                    <ul>
                                        <li>
                ...
                {fetchedBagian.map((bagian, index)=>
                    <>
                        ...
                        <div className="grid grid-rows-1 md:grid-rows-3 md:grid-flow-col gap-4 px-2">
                            ...
                            {/* Section 1 */}
                            <div className={`hidden row-span-3 md:invisible md:block col-span-7 md:col-span-1 bg-white border-2 border-gray-300/40 shadow-md rounded-md`}>
                                <div className="inline-flex bg-gray-300/40 w-full rounded-t-md p-2">
                                    <div className="bg-gray-100 text-gray-800  items-center px-1.5 py-0.5 mt-0.5 rounded-md">
                                    ...
                                    <div className="text-xl font-medium ml-1.5 text-gray-700">
                                        {projectData.labelProject.split(" ")[0] === "Bangkit" ? "Informasi Bangkit" : projectData.labelProject === "MGE" ? "Informasi Proyek" : "Informasi"}
                                    </div>
                                    {projectData.picProject === getCurrentEmail && getCurrentRole === "user" && (
                                    <>
                ...
                <div className="grid grid-rows-1 md:grid-rows-3 md:grid-flow-col gap-4 px-2">
                    ...
                    <div className={`hidden row-span-3 md:invisible md:block col-span-7 md:col-span-1 bg-white border-2 border-gray-300/40 shadow-md rounded-md`}>
                        <div className="inline-flex bg-gray-300/40 w-full rounded-t-md p-2">
                            ...
                            <div className="text-xl font-medium ml-1.5 text-gray-700">
                                {projectData.labelProject.split(" ")[0] === "Bangkit" ? "Informasi Bangkit" : projectData.labelProject === "MGE" ? "Informasi Proyek" : "Informasi Proyek"}
                            </div>
                            {projectData.picProject === getCurrentEmail && getCurrentRole === "user" && (
                            <>
        ...
        <>
             <div className="min-h-full">
                ...
                <header className="bg-white drop-shadow-md">
                    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900">Proyek Tidak Ditemukan</h1>
                    </div>
                </header>

                {/* Start - Content */}
                <main>
                    <div className="lg:mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 px-4">Pastikan kamu menekan tombol "Buka" di halaman Proyek.</div>
                </main>
                {/* End - Content */}
