    ...
    <div className="min-h-full">
      ...
      <header className="bg-white drop-shadow-md">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Cari Proyek</h1>
        </div>
      </header>
                    ...
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                      <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                          ...
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              Apakah kamu yakin untuk bergabung di proyek ini, proses ini tidak bisa dibatalkan dan kamu akan terdaftar di kelas ini.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  {/* Header */}
                    ...
                    {/* Search */}
                          ...
                          <div className="relative">
                              ...
                              autoComplete='off'
                              placeholder="Cari proyek (contoh:projek-xxxx-xx)"
